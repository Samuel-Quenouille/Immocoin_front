...
// node_modules/.pnpm/jotai@2.4.1_@types+react@18.2.15_react@18.2.0/node_modules/jotai/esm/vanilla.mjs
var keyCount = 0;
...
var createStore = () => {
  ...
  const writeAtomState = (updatedAtoms, atom2, ...args) => {
    let isSync = true;
  ...
  const writeAtom = (atom2, ...args) => {
    ...
    const result = writeAtomState(updatedAtoms, atom2, ...args);
    recomputeDependents(updatedAtoms);
    const flushed = flushPending();
    if ((import.meta.env ? import.meta.env.MODE : void 0) !== "production") {
      storeListenersRev2.forEach(
...
// node_modules/.pnpm/jotai@2.4.1_@types+react@18.2.15_react@18.2.0/node_modules/jotai/esm/react.mjs
